...
class DebugToolWindow(QWidget): # QWidget을 상속받는 클래스를 만들어.
    ...
    def setup_connections(self):
        ...
        self.btnA1.clicked.connect(lambda: self.send_waypoint("A1"))
        self.btnA2.clicked.connect(lambda: self.send_waypoint("A2"))
        self.btnA3.clicked.connect(lambda: self.send_waypoint("A3"))
        self.btnB1.clicked.connect(lambda: self.send_waypoint("B1"))
        self.btnB3.clicked.connect(lambda: self.send_waypoint("B3"))
        self.btnC1.clicked.connect(lambda: self.send_waypoint("C1"))
        self.btnC3.clicked.connect(lambda: self.send_waypoint("C3"))
        self.btnC4.clicked.connect(lambda: self.send_waypoint("C4"))
        self.btnC5.clicked.connect(lambda: self.send_waypoint("C5"))
        self.btnC6.clicked.connect(lambda: self.send_waypoint("C6"))
        self.btnC7.clicked.connect(lambda: self.send_waypoint("C7"))
        self.btnC8.clicked.connect(lambda: self.send_waypoint("C8"))
        self.btnC9.clicked.connect(lambda: self.send_waypoint("C9"))
        self.btnD3.clicked.connect(lambda: self.send_waypoint("D3"))
        self.btnD5.clicked.connect(lambda: self.send_waypoint("D5"))
        self.btnD7.clicked.connect(lambda: self.send_waypoint("D7"))
        self.btnD9.clicked.connect(lambda: self.send_waypoint("D9"))
        self.btnE3.clicked.connect(lambda: self.send_waypoint("E3"))
        self.btnE4.clicked.connect(lambda: self.send_waypoint("E4"))
        self.btnE5.clicked.connect(lambda: self.send_waypoint("E5"))
        self.btnE6.clicked.connect(lambda: self.send_waypoint("E6"))
        self.btnE7.clicked.connect(lambda: self.send_waypoint("E7"))
        self.btnE8.clicked.connect(lambda: self.send_waypoint("E8"))
        self.btnE9.clicked.connect(lambda: self.send_waypoint("E9"))
